...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-4 left-0 w-full z-50 flex justify-center px-4">
      <nav 
        ref={navRef}
        className="w-full max-w-7xl bg-white/90 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(31,38,135,0.1)] border border-white/40 rounded-2xl px-6 lg:px-10"
      >
